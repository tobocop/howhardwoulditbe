...
describe Plink::Password do
  ...
  it "has a hash constructed using SHA-256" do
    password = Plink::Password.new(unhashed_password: "AplaiNTextstrIng55")
  ...
  it 'returns a blank hash for a blank password' do
    password = Plink::Password.new(unhashed_password: nil)
  ...
  describe 'class methods' do
    it 'autogenerates a password' do
      SecureRandom.stub(:uuid) { 'my-uuid' }
      password = double
      Plink::Password.should_receive(:new).with(unhashed_password: 'my-uuid') { password }
      Plink::Password.autogenerated.should == password
    end
  end
end

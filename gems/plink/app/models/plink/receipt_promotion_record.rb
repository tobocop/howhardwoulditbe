module Plink
  class ReceiptPromotionRecord < ActiveRecord::Base
    ...
    belongs_to :advertiser_record, class_name: 'Plink::AdvertiserRecord', foreign_key: 'advertiser_id'

    attr_accessible :advertiser_id, :award_type_id, :description, :end_date, :name,

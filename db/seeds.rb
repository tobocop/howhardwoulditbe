...
amazon_reward = create_reward(name: 'Amazon.com Gift Card', terms: 'legal terms', amounts: [ new_reward_amount(dollar_award_amount: 5, is_active: true), new_reward_amount(dollar_award_amount: 10, is_active: true), new_reward_amount(dollar_award_amount: 15, is_active: true), new_reward_amount(dollar_award_amount: 25, is_active: true), new_reward_amount(dollar_award_amount: 50, is_active: true), new_reward_amount(dollar_award_amount: 100, is_active: true)], description: "Online retailer of books, movies, music and games along with electronics, toys, apparel, sports, tools, groceries and general home and garden items.")

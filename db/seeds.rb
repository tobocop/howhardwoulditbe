...
create_reward(name: 'Subway Gift Card', logo_url: '/assets/gift-cards/subway.png', amounts: [ new_reward_amount(dollar_award_amount: 10, is_active: true), new_reward_amount(dollar_award_amount: 20, is_active: true)])

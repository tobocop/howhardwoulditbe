class GigyaSocialLoginService
  ...
  def create_user_from_gigya
    ...
    user = Plink::User.create!(email: email, first_name: first_name, password_hash: password.hashed_value, salt: password.salt, avatar_thumbnail_url: avatar_thumbnail_url)

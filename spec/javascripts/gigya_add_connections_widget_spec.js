describe('Plink.GigyaAddConnectionsWidget', function () {
  ...
  describe('#setup', function () {
    it('shows the Add Connections UI when social-link-widget is on the page', function () {
      ...
      expect(window.gigya.socialize.showAddConnectionsUI).toHaveBeenCalledWith({showTermsLink: false, showEditLink: true, hideGigyaLink: true, enabledProviders: 'facebook,twitter', containerID: 'social-link-widget', width: 224, height: 70});
    });

...
describe VirtualCurrencyPresenter do
  ...
  describe '#subdomain' do
    it 'returns the subdomain of the virtual currency' do
      presenter = VirtualCurrencyPresenter.new(virtual_currency: double(subdomain: 'www'))
  ...
  describe '#amount_in_currency' do
    it 'returns the given amount * the currency\'s exchange rate' do
      presenter = VirtualCurrencyPresenter.new(virtual_currency: double(exchange_rate: 100))
  ...
  describe '#currency_name' do
    it 'returns the name of the provided currency' do
      presenter = VirtualCurrencyPresenter.new(user_balance: 1.0, virtual_currency: double(name: 'Plonk Points'))
  ...
  describe '#exchange_rate' do
    it 'returns the exchange rate of the provided currency' do
      presenter = VirtualCurrencyPresenter.new(user_balance: 1.0, virtual_currency: double(exchange_rate: 100, name: 'Plonk Points'))
  ...
  describe '#id' do
    it 'returns the id of the provided virtual currency' do
      presenter = VirtualCurrencyPresenter.new(user_balance: 1.0, virtual_currency: double(id: 143))

...
describe TrackingObject do
  ...
  describe '.new' do
    it 'takes a hash of tracking params and stores them in the object' do
      ...
      tracking_object.referrer_id.should == 128
    ...
    it 'can be initialized with a blank hash and use defaults' do
      ...
      tracking_object.referrer_id.should == nil
  ...
  describe '.to_hash' do
    it 'can build a hash of proper tracking params based on a hash' do
      ...
      my_hash[:referrer_id].should == 128
    ...
    it 'can build a hash without all the valid params' do
      ...
      my_hash[:referrer_id].should == nil
  ...
  describe '.steelhouse_additional_info' do
    it 'generates the additional info string for a steelhouse pixel' do
      ...
      steelhouse_additional_info.should == '&affiliateid=1732,&campaignid=234,&landing_page_id=2,&subid2=subid 2,&subid3=subid 3,&subid4=subid 4,&subid=subid 1,&virtualcurrencyid=123,'
    end
    ...
    it 'generates the additional info string for a steelhouse pixel without valid_options' do
      ...
      steelhouse_additional_info.should == '&affiliateid=1,&campaignid=,&landing_page_id=,&subid2=,&subid3=,&subid4=,&subid=,&virtualcurrencyid=123,'
    end
  end

  ...
  describe '.new' do
    ...
    context 'when gigya_user id is not an integer' do
      ...
      context 'when we cannot find the user by email' do
        before do
          Plink::User.stub(:find_by_email).with('bob@example.com') { nil }
        ...
        it 'creates a new user' do
          ...
          Plink::User.should_receive(:create!).with(email: 'bob@example.com', first_name: 'Bob', password_hash: 'my-hashed-password', salt: 'my-salt', avatar_thumbnail_url: 'http://www.example.com/my-avatar.jpg') { user }
        ...
        it 'should raise when user creation fails' do
          Plink::User.should_receive(:create!).with(email: 'bob@example.com', first_name: '', password_hash: 'my-hashed-password', salt: 'my-salt', avatar_thumbnail_url: nil) { raise(ActiveRecord::RecordInvalid, stub(errors: stub(full_messages: []))) }
        ...
        it 'notifies Gigya of a user registration' do
          user = stub(id: 123, avatar_thumbnail_url?: true)
          Plink::User.should_receive(:create!) { user }

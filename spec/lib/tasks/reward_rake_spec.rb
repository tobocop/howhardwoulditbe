...
describe 'reward:add_new_tango_rewards' do
  ...
  it 'inserts 1-800-Flowers with the correct amounts' do
    ...
    flowers.description.should == "Gift-giving has never been easier with the 1-800-FLOWERS.COM Gift Card! Browse a wide selection of fresh flowers, delicious gourmet treats and desserts, beautiful plants, stunning gift baskets and more – and then choose exactly what you want!"
    ...
    flowers.name.should == "1-800-FLOWERS.COM® Gift Card"
  ...
  it 'inserts Barnes & Nobles with the correct amounts' do
    ...
    barnes.description.should == "The Barnes & Noble eGift Card can be redeemed at any Barnes & Noble store and online at BN.com (www.bn.com) – where you’ll find an amazing selection of books, NOOK Books™, (eBooks), CDs, DVDs, toys, games, and more. It can also be redeemed for NOOK eReader devices."
  ...
  it 'inserts home depot with the correct amounts' do
    ...
    home.name.should == "The Home Depot® eGift Card"
  ...
  it 'inserts target with the correct amounts' do
    ...
    target.description.should == "A Target eGiftCard is your opportunity to shop for thousands of items at more than 1,700 Target and SuperTarget® stores in the U.S., as well as Target.com. From home decor, small appliances and electronics to fashion, accessories and music, find exactly what you're looking for at Target. No fees. No expiration. No kidding.®"
  ...
  it 'inserts burger king with the correct amounts' do
    ...
    bk.description.should == "The original HOME OF THE WHOPPER®, our commitment to premium ingredients, signature recipes, and family-friendly dining experiences is what has defined our brand for more than 50 successful years."
  ...
  it 'inserts best buy with the correct amounts' do
    ...
    bestbuy.description.should == "The original HOME OF THE WHOPPER®, our commitment to premium ingredients, signature recipes, and family-friendly dining experiences is what has defined our brand for more than 50 successful years."
